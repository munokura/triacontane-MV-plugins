...
@plugindesc Battle Abandonment Plugin ~Farewell to Weapons~
@author Triacontane
@license MIT License
...
You can now use the "Surrender" command to voluntarily abandon battle and
treat it as a defeat.
Normally, this would result in a Game Over,
but if you allowed defeat in the event battle, the event will continue.
Let's have a defeat event!

Plugin Command Details
Execute from the "Plugin Command" event command.

FTA_INVALID
- Disables the selection of the surrender command.
FTA_VALID
- Re-enables the selection of the surrender command.
...
@desc The command name that appears in the window.
@default surrender

@param farewellYes
@desc This is an option for surrender.
@default give up

@param farewellNo
@desc This is an option if you want to continue the fight.
@default Don't give up

@param farewellDescription
@desc This is the explanation that will be displayed at the top of the screen when you confirm.
@default Do you stop resisting and surrender? (This will be considered defeat.)

@param farewellMessage
@desc This is the message that will be displayed when you post.
@default %1 stopped fighting and surrendered.
*/
