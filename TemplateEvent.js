...
@param Image
@text Image
@desc The event's image and image index.
@type boolean
@default false

@param Direction
@text Direction
@desc The event's direction and animation pattern.
@type boolean
@default false

@param Move
@text Autonomous Movement
@desc The event's autonomous movement.
@type boolean
@default false

@param Priority
@text Priority
@desc The event's priority.
@type boolean
@default false

@param Trigger
@text Trigger
@desc The event's trigger.
@type boolean
@default false

@param Option
@text Options
@desc The event's options.
@type boolean
@default false
*/
