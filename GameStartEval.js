...
@plugindesc Run Script at Startup Plugin
@author Triacontane
@license MIT License
...
-----
Executes an arbitrary script when the game starts.
This is the timing of Scene_Boot.start.
...
@param スクリプト1
@text Script 1
@desc Script to run when the game starts
