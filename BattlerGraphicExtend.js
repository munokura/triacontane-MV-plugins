...
<BGETone: r, g, b, g> r: Red g: Green b: Blue (-255..255) g: Gray (0..255)
Example: <BGETone: 255, 255, 255, 128>

Makes the battler blink slowly. Specify each element numerically. This
process is somewhat heavy, so please be careful when running on mobile
devices.
<BGEFlash: r, g, b, a> r: Red g: Green b: Blue a: Intensity (0..255)
Example: <BGEFlash: 255, 0, 0, 128>

To change the flash interval (a smaller value means faster flashing; the
default is 15).
<BGEFlashInterval: f> f: Number of frames
Example: <BGEFlashInterval: 30>

Sets the butler's blending method.
<BGEBlendMode: n> n: 0 [Normal] n: 1 [Add] n: 2 [Multiply] n: 3
[Screen]
Example: <BGEBlendMode: 2>

Sets the butler's magnification. A value of -100 will invert the image.
<BGEScaleX:n> n: Magnification (100%)
<BGEScaleY:n> n: Magnification (100%)
Example: <BGEScaleY:150>

Sets the butler's motion speed.
This setting is only valid for actors.
<BGEMotionRaten> n: Magnification (100%)
Example: <BGEMotionRate:150>
