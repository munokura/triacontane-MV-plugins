...
@plugindesc Character spacing plugin
@author Triacontane
@license MIT License
...
You can set character spacing for text.
The value of the specified variable will become the character spacing
(in pixels).
...
@desc The variable number that receives the character spacing value (in pixels).
@type variable
@default 0
*/
