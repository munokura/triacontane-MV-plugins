...
Memorize and recreate favorite equipment patterns using plugin commands.

Plugin Command Details
Execute from the "Plugin Command" event command.
(Parameters must be separated by a space.)

FE_SET_FAVOURITE 1 3
- Sets the equipment of the actor with ID [1] to favorite [3].
FE_GET_FAVOURITE \v[2] 3
- Restores the equipment in [3] to the actor with ID [2].

There is no limit to the number of favorite settings. Please specify a
value of 1 or greater.

Script Details
$gameActors.actor(id).getFavouriteEquipName(index, slotId);

Gets the equipment name of the favorite [index] [slotId] of the actor
specified by [id].
