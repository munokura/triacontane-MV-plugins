...
@plugindesc Mute Omission Plugin
@author Triacontane
@license MIT License
...
This plugin will not play or load audio files such as background music if
the volume or master volume is set to 0 or if any switches are turned on.

This plugin can reduce data usage when playing browser games over a mobile
network.
...
@desc If the switch with the specified number is ON, the audio file will not be acquired.
@type switch
@default 0
*/
