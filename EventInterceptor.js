...
This allows you to automatically interrupt a specified common event at the
start or end of an event. This applies to map events.
Use this when you want to execute some common processing.
Enter the tag specified in the parameter in the event's Note field.
<EvTp:aaa>

You can interrupt unconditionally by omitting the tag.
In that case, set the following tag in the Note field for events you do
not want to interrupt.
<EvTp:none>

If you "move location" during an event, the end of the event will not be
interrupted.
