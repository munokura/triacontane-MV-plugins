...
@plugindesc Failure Effect Plugin
@author Triacontane
@license MIT License
...
Allows you to apply a certain percentage of damage to some effects even if the
action fails.
The damage multiplier upon failure can be specified in the parameters or the
skill's Note field.

<FE_FailureRate:10>
 # The damage multiplier upon failure is set to [10%].
<FE_FailureEffect:2,3>
 # The [2nd] and [3rd] effects are still applied upon failure.
...
@desc Damage multiplier (%) when the skill fails. If there is an individual setting in the Note field for each skill, that setting will take priority.
@type number
@default 30

@param FailureMessageOutput
@desc Whether to output a message on failure.
@type boolean
@default false
*/
