...
You can also set the vibration method to a sine wave instead of the
standard vibration, creating a unique rhythmic effect.

If necessary, execute the following command immediately before executing
"Screen Shake."
The setting will automatically reset when the shake ends.

Plugin Command Details
Execute from the "Plugin Command" event command.
(Separate parameters with a space.)

DS_SET_ROTATION 90 # Vibrates at an angle of [90 degrees]. (Angle:0...360)
DS_SIN_WAVE # Sets the vibration to a sine wave.
