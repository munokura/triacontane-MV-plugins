...
-----
You can set whether to apply blurring when enlarging an image for each image
type.

Without blurring, the image will appear clear, but dots will be visible.

By standardizing the settings, you can achieve a more natural look when using
Parallax Mapping or other methods that create a noticeable difference between
the distant view, picture, and character.

Note that blurring is virtually invisible to the naked eye unless the image is
enlarged.
