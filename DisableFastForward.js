...
This option disables the double-speed event processing that occurs when you
hold down the confirm button or mouse during an event.
This does not affect message sending or the increased speed of the battle
screen.

You can disable/enable this setting using the plugin command.
The setting value is saved in your save data.
...
Disables fast-skipping of events.

ENABLE_FAST_FORWARD
Enables fast-skipping of events.
