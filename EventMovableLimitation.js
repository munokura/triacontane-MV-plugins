...
@plugindesc Event Movement Range Restriction Plugin
@author Triacontane
@license MIT License
...
EventMovableRange.js

Limits the range within which an event can be moved.
Attempting to move beyond the limit from the initial position will prevent
the event from moving.
Specify the following in the event's Note field:
<Movable: u, d, l, r>
u: Number of tiles that can be moved upward
d: Number of tiles that can be moved downward
l: Number of tiles that can be moved left
r: Number of tiles that can be moved right
Specifying a negative value, such as -1, will allow unlimited movement in
