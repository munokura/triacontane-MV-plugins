...
Enter the following in the Note field of the characteristic database (※1).

<CurseSkill1:20>
 # Uses skill ID [20] regardless of the selected action.
<CurseRate1:50>
...
<CurseRate2:50>
<CurseCond2:s>
If multiple action conditions are met, the action will be determined randomly.

This plugin does not have any plugin commands.

Terms of Use:
You may modify and redistribute it without permission from the author, and
there are no restrictions on its use (commercial use, use under 18+, etc.).
