...
@plugindesc Battle balloon display plugin
@author Triacontane
@license MIT License
...
2. Automatically activates upon counterattack or evasion
If you specify this in the parameters, a balloon with the specified ID will
automatically be displayed at the moment of counterattack, evasion, magic
reflection, or substitution.

3. Automatically activates upon skill execution
Automatically activates when a skill or item is used.
Please enter the following in the memo field.
...
@desc This is the speed multiplier (rate) for displaying speech bubbles. It does not affect the speech bubbles on the map screen.
@default 100

@param BalloonWaitTime
@desc The waiting time (frames) after the balloon is displayed. This does not affect the balloon on the map screen.
@default 12

@param BalloonIdEvasion
@desc The balloon ID to display when evading.
@default 0

@param BalloonIdCounter
@desc The speech bubble ID to display when counterattacking.
@default 0

@param BalloonIdSubstitute
@desc This is the speech bubble ID to display when substituting.
@default 0

@param BalloonIdReflection
@desc The balloon ID to display when reflected.
@default 0
*/
