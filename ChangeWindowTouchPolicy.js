...
@plugindesc Window touch specification change plugin
@author Triacontane
@license MIT License
...
-----
Change the behavior when you touch or click the window.
1. Focus on an item when you hover the mouse over it.
2. Click once while focused to confirm the item.
3. Adds customizable behavior when clicking outside the window.
...
@desc Select the action to take when touching outside the window frame (OK, Cancel, or None).
@default キャンセル
*/
