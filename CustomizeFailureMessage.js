...
<CFM:%1aaa> # "[Target Battler Name]aaa" will be displayed.

*Customization is limited to the message displayed when the action fails.
This is not the message displayed when the opponent evades the action.
