...
@help
During battle, damage magnification will rise when friendly attacks are
continuous.
Maximum collaboration damage is displayed simultaneously with the number
of chains.
It will be canceled when chain of opponent starts during chain
continuation.
...
Can use \v[n]
<AC_Rate:200>
 # Set the chain damage magnification to 200% further.
<AC_End>
 # I will forcibly terminate cooperation with that skill.
<AC_Cond:5>
 # 5 Failure to use with less than cooperation always fails.

You can set skill change when the number of cooperation becomes constant.
<AC_SkillChangeChain:2>
 # Skill changes over 2 collaboration.
<AC_SkillChangeId:10>
 # Set skill ID after skill change to [10].
<AC_SkillChangeMessage:aaa>
 # Message [aaa] is displayed when the skill changes.
...
$gameParty.getChainCount();
 # Acquisition of number of current parties
$gameParty.getMaxChainCount();
 # Get maximum number of parties
$gameParty.getChainDamage();
 # Current Party collaboration Damage Acquisition
$gameParty.getMaxChainDamage();
 # Get party's maximum collaboration damage
$gameParty.resetMaxChain();
 # Reset maximum cooperation number and damage
...
@param UnitImage
@desc This image displays the chain count unit. If specified, this takes precedence.
@default
@require 1
@dir img/system/
@type file
...
@desc This image displays the damage units for the chain count. If specified, this takes precedence.
@default
@require 1
@dir img/system/
@type file
...
@desc This is the file name suffix to use when you want to specify separate unit images and damage unit images for enemies.
@default
...
@desc This is a numerical image file displaying combo counts. Please prepare an image with the numbers 0 through 9 arranged horizontally at equal intervals.
@default
@require 1
@dir img/system/
@type file
...
@desc This is a numerical image file for displaying combo damage. Please prepare an image with the numbers 0 through 9 arranged horizontally at equal intervals.
@default
@require 1
@dir img/system/
@type file
...
@desc This is the file name suffix to use when you want to specify separate chain images and damage images for enemies.
@default
