...
This plugin allows you to gain a certain amount of experience points
gained in battle even for actors outside your party.

However, this plugin cannot be used with save data that was not previously
installed.
...
@param invalidSwitch
@text Disable Switch
@desc When the specified switch is ON, non-party members will not gain experience points.
@type switch
@default 0
*/
