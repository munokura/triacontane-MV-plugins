...
Replaces the region ID conditions for encounter creation in map settings
with switches. Normal region ID filtering is disabled.

Example:
Specifying region ID [6] in map settings.

The original region ID [6] condition is ignored, and the specified enemy
group will only be encountered if switch number [6] is ON.
