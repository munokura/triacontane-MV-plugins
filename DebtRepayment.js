...
Allows you to set your balance to negative.

Plugin Command Details
Execute from the "Plugin Command" event command.
(Separate parameters with a space.)

Temporarily disables setting your balance to negative.
DR_DEBT_DISABLE

Re-enables setting your balance to negative.
DR_DEBT_ENABLE

If your balance is negative, it will be reset to zero.
DR_REPAY_GOLD
...
@desc This is the minimum price that can be purchased at the store. If specifying a price, please specify a negative value. The control character \v[n] can be specified.
@default 0

@param DebtTextColor
@desc Changes the text color when in debt in the Money window. Specify the system color number (\c[n]).
@default 0
*/
