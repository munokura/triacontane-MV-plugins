...
You can create an item or skill that executes a script when used.
JavaScript knowledge is required to use this plugin.
Specify the following in the Note field:
<SCRIPT: (Script to execute)>

Set the effect range to all allies or all enemies to execute the script
for all targets.
...
- Target of the item
v(n)
- Gets the value of variable [n]
sv(n, m)
- Sets variable [n] to value [m]
s(n)
- Gets the value of switch [n]
ss(n, m)
- Sets switch [n] to value [m]
